...
The `StartData` associated type provides all the necessary context for the actor to run,
including communication channels, cancellation tokens, and configuration.
