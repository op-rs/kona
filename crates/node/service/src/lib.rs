...
mod service;
pub use service::{
    FollowClientConfig, InteropMode, L1Config, L1ConfigBuilder, NodeMode, RollupNode,
    RollupNodeBuilder,
};

mod follow;
pub use follow::{FollowClient, FollowClientError, FollowStatus, HttpFollowClient};
...
pub use actors::{
    ...
    EngineContext, EngineError, EngineInboundData, FollowActor, FollowActorError,
