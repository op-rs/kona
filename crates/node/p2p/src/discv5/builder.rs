...
#[derive(Debug, Clone)]
pub struct AdvertisedIpAndPorts {
    pub ip: IpAddr,
    pub tcp_port: u16,
    /// Fallback UDP port.
    pub udp_port: u16,
...
impl AdvertisedIpAndPorts {
    /// Creates a new [`AdvertisedIpAndPorts`] instance.
...
pub struct Discv5Builder {
    ...
    advertised_address: Option<AdvertisedIpAndPorts>,
...
impl Discv5Builder {
    ...
    pub fn with_address(mut self, address: AdvertisedIpAndPorts) -> Self {
...
mod tests {
    ...
    fn test_builds_valid_enr() {
        let addr = AdvertisedIpAndPorts::new(IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)), 9099, 9099);
