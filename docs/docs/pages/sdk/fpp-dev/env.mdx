...
Before kicking off the development of your own [Fault Proof Program](../glossary.mdx#fault-proof-program),
...
to communicate with one another is synchronously through the [Preimage ABI](../glossary.mdx#preimage-abi) ([specification][preimage-specs]).
