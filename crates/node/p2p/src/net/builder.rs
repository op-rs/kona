...
use crate::{
    ...
    NetworkBuilderError, PeerMonitoring, PeerScoreLevel, discv5::AdvertisedIpAndPorts,
};
...
impl NetworkBuilder {
    ...
    pub fn with_discovery_address(self, address: AdvertisedIpAndPorts) -> Self {
...
mod tests {
    ...
    fn test_build_simple_succeeds() {
        ...
        let disc_enr = AdvertisedIpAndPorts::new(IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)), 9098, 9098);
    ...
    fn test_build_network_custom_configs() {
        ...
        let mut gossip_addr = Multiaddr::from(gossip.ip());
        gossip_addr.push(libp2p::multiaddr::Protocol::Tcp(gossip.port()));
        let disc = AdvertisedIpAndPorts::new(IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)), 9097, 9097);
