...
| ---------------------------- | ------------------------------------------------------------------------------------------------------ | --------- |
| [`opp2p`](/node/rpc/p2p)      | The `opp2p` API allows you to configure the p2p stack.                                                 | Maybe     |
| [`optimism`](/node/rpc/rollup)| The `optimism` API provides OP Stack specific rpc methods.                                             | No        |
