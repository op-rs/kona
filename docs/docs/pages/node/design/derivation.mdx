...
This method continuously steps through the pipeline until payload attributes are produced:
...
- Other reset errors: Wait for the external signal before continuing
