...
pub struct RollupNode {
    ...
    /// The L1 node configuration.
    pub(crate) l1_config: L1NodeConfig,
    /// The L2 EL provider.
...
impl RollupNode {
    ...
    fn da_watcher_builder(&self) -> L1WatcherRpcState {
        L1WatcherRpcState {
            ...
            l1_provider: self.l1_config.provider.clone(),
        }
    }
    ...
    fn derivation_builder(&self) -> DerivationBuilder {
        DerivationBuilder {
            ...
            l1_beacon: self.l1_config.beacon.clone(),
